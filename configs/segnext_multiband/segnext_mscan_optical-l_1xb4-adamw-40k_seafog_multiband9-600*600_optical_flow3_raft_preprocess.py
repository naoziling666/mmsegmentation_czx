...
data_preprocessor = dict(
    ...
    mean=[74.209, 86.325, 57.107, 74.369, 86.603, 57.575, 74.561, 86.925, 58.081,174.37, 236.88, 228.24],
    std=[31.693, 38.081, 29.844, 31.743, 38.191, 30.117, 31.791, 38.303, 30.394,44.88, 15.54, 20.47],
    bgr_to_rgb=False,
    pad_val=0,
    seg_pad_val=255,
    size=(600,600),
