...
def main():
    ...
    labels_path = '/root/autodl-pub/CZX/mmsegmentation_czx/data/snow_ice_data/label/val_maskrcnn'
    pred_path = '/root/autodl-pub/CZX/mmsegmentation_czx/work_dirs/ice_snow/pred/pred_maskrcnn'
    save_path = '/root/autodl-pub/CZX/mmsegmentation_czx/work_dirs/ice_snow/vis_maskrcnn'
